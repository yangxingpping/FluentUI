    ...
    Shape {
        ShapePath {
            ...
            PathSvg { 
                ...
                path: "M38.3513 0C34.6227 0 31.2038 2.0744 29.4817 5.38152L0 %2H765.497H922C923.105 %2 %1 61.1046 %1 60V0H38.3513Z".arg(mainBottomBasePane.width).arg(mainBottomBasePane.height)
